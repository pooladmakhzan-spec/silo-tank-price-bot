...
SCREW_LENGTH, SCREW_OUTER_DIAMETER, SCREW_OUTER_THICKNESS, SCREW_SHAFT_DIAMETER, SCREW_SHAFT_THICKNESS, SCREW_PITCH, SCREW_BLADE_THICKNESS, SCREW_BLADE_RADIUS, MOTOR_PRICE, LATHE_WAGE, TRANS_SHAFT_DIAMETER, TRANS_SHAFT_LENGTH, TRANS_SHAFT_PRICE, SCREW_WAGE = range(30)
